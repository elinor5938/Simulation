...
def graph_for_intresting_col(df,intresting_col):
    ...
    #ax1.scatter([i for i in range(len(df.loc[df['probabilty_res_MCMC'] == "True"]))], df[str(intresting_col)][#f##['probabilty_res_MCMC'] == "True"])
...
y_parameters=["WB","SB","NB","total_binders","NB_delta","WB_delta","SB_delta","sum_of_all_hla","sum_of_all_hla","average","median","all_data_prob"]
#df_no_sim.info()

################################################no simulation version ###########################################
...
# df_no_sim.to_csv("df of 5000 peptide no simulation made "+ "seed is 86.csv")
#
